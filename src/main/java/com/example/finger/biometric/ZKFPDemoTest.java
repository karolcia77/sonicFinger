package com.example.finger.biometric;
...
public class ZKFPDemoTest extends JFrame{
	...
	public void launchFrame(){
		...
		radioISO = new JRadioButton("ISO");// 创建单选按钮
		this.add(radioISO);  
      ...
      //For End
		...
		this.setTitle("Sonic"); // ZKFinger Demo
		...
		btnEnroll.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!bRegister)
				{
					enroll_idx = 0;
					bRegister = true;
					textArea.setText("Please your finger 3 times!");  //  请你的手指3次！
				}
			}
			});
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (0 == ret)
				{
					...
					else
					{
						if(cbRegTemp <= 0)
						{
							textArea.setText("Please register first!-请先注册！");
						}
						else
						{
